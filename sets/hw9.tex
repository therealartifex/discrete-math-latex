...
t_n &= -\frac{1}{3}(-2)^n + \frac{1}{12}(4)^n \\[5mm]
\end{aligned} $
...
t_n &= 3^n\left(\frac{16}{9} - \frac{7}{9}n\right) \\[5mm]
\end{aligned} $
...
t_n &= -\frac{2}{3}(-3)^n + \frac{1}{2}(-2)^n \\[5mm]
\end{aligned} $
...
t_n &= \frac{3}{25}(-5)^n -\frac{2}{25}(5)^n \\[5mm]
\end{aligned} $\\[5mm]
\end{enumerate}
